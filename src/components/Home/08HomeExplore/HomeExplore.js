...
const HomeExplore = () => {
  return (
    <>
      ...
      <div className="flex flex-wrap md:gap-40 gap-10 justify-evenly max-w-screen-xl mx-auto my-10 bg-white">
        {exps.map((exp, i) => (
          <Link key={i} href={exp.link} className="hover:bg-[#d17a29] p-2 rounded-lg max-w-64 hover:text-white transition-all duration-300 text-gray-800 no-underline hover:no-underline">
            <img
